...
python -m mani_skill.examples.mycodes.test_mplib --render-mode="human" --shader="rt-fast" -c "pd_joint_delta_pos" -e "GraspCube-v1" -r "dual_piper"
...
class ManiSkillPiperDemo:
    def __init__(self,args):
        ...
        self.env = gym.make(
            args.env_id,    #PushCube-v1、GraspCube
            obs_mode="none",
...
#========PushCube-v1========
    ...
    def move_to_pose(self, pose, with_screw=True, headless=False):
        world_pose = self.robot_to_world(pose , self.robot.get_root_pose().raw_pose[0].tolist())    #转化为世界坐标系仅为了打印
...
if __name__ == "__main__":
    ...
    if "PushCube" in args.env_id:
        demo.pick_cube_demo()   #执行自动抓取demo #[0.01, 0.07, 0.19, 0.01, -0.00, 1.00, 0.00] [-0.19, 0.07, 0.22, 0.00, 0.00, 1.00, 0.00]
    ...
    elif "GraspCube" in args.env_id:
        print("Exerting grasp_cube")
        demo.grasp_cube_demo()